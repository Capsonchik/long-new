export const selectAddNewParam = (state) => state.main.isAddNewParam;
export const selectLong = (state) => state.main.longitude;
export const selectSocio = (state) => state.main.socio;
